...
val ColorFF534A = Color(0xFFFF534A)
...
fun ColorFFFFFF_28() = ColorFFFFFF.copy(alpha = 0.28f)
fun Color1A1A1A_80() = Color1A1A1A.copy(alpha = 0.80f)
fun ColorFF534A_30() = ColorFF534A.copy(alpha = 0.30f)
fun Color4CAF50_30() = Color4CAF50.copy(alpha = 0.30f)
